    ...
    rules: {
        ...
        'import/no-extraneous-dependencies': [
            baseImportsRules['import/no-extraneous-dependencies'][0],
            {
                ...
                devDependencies: baseImportsRules['import/no-extraneous-dependencies'][1].devDependencies.reduce((result, developmentDep) => {
                    const toAppend = [developmentDep];
                    const developmentDepWithTs = developmentDep.replace(/\bjs(x?)\b/g, 'ts$1');
